...
load('spect_store_200_store.mat','spect_store_200');  % observed spectra

% Observed amplitude spectra (row vectors)
obs_amp_1 = spect_store_200(:,3)';   % sample #1
obs_amp_2 = spect_store_200(:,4)';   % sample #2

%% ---------------------- MCMC configuration ------------------------------
kk  = 32;        % run label for output files
global tau
...
Q_ml_s = 150;             % initial flow in ml/s (for readability)
Q0     = Q_ml_s * 1.2e-6;
