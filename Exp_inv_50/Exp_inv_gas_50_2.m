...
load('spect_store_50_store.mat','spect_store_50');  % observed spectra

% Observed amplitude spectra (row vectors)
obs_amp_1 = spect_store_50(2,:);   % sample #1
obs_amp_2 = spect_store_50(1,:);   % sample #2

%% ---------------------- MCMC configuration ------------------------------
kk  = 12;        % run label for output files
global tau
...
Q_ml_s = 40;             % initial flow in ml/s (for readability)
Q0     = Q_ml_s * 1.2e-6;
